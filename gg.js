let queens=[{
  ...
  function moment(position,dir,moves){
    ...
    var y=position[1];
    if(x>=8||y>=8||x<0||y<0){
      document.write("Check Your Start Poistion \n")
    }
    else{
  switch(dir){
    case "S":
    ...
    case "SW":
      ...
      break;
    default:
      document.write("Check your direction! \n");
  }
      var arr=[x,y];
    if(((x>=8)||(x<0))||((y<0)||(y>=8))){
      document.write("<br\>Oops! This move is out the chess board ! <br\>")
    }
    else{
    return arr;}
    }
  ...
  if(arr!=null){
    ...
    if(final==true){
      document.write("<br/>Already One Queen is there Please Check your moves<br/>");
    }
    else{
     document.write(updatePosition(arr)+"<br/>");
